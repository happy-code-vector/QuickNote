      ...
      <section id="features" className="py-16 px-4 bg-white dark:bg-gray-900">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <h3 className="text-3xl md:text-4xl font-bold mb-4">Powerful Learning Tools</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="feature-card">
              ...
              <h4 className="text-lg font-bold mb-2">Flexible Uploads</h4>
            ...
            <div className="feature-card">
              ...
              <h4 className="text-lg font-bold mb-2">Smart Flashcards</h4>
              <p className="text-sm text-gray-600 dark:text-gray-400">
            ...
            <div className="feature-card">
              ...
              <h4 className="text-lg font-bold mb-2">Interactive Quizzes</h4>
              <p className="text-sm text-gray-600 dark:text-gray-400">
            ...
            <div className="feature-card">
              ...
              <h4 className="text-lg font-bold mb-2">Smart Notes</h4>
              <p className="text-sm text-gray-600 dark:text-gray-400">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-8">
            <div className="flex gap-6">
              ...
              <div>
                <h4 className="text-xl font-bold mb-2">Upload Your Content</h4>
            ...
            <div className="flex gap-6">
              ...
              <div>
                <h4 className="text-xl font-bold mb-2">AI Generates Materials</h4>
                <p className="text-gray-600 dark:text-gray-400">
      ...
      <footer className="py-8 px-4 border-t border-gray-200 dark:border-gray-800">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex gap-6">
              <Link href="/terms" className="text-sm hover:text-blue-600 transition-colors">Terms of Service</Link>
              <Link href="/privacy" className="text-sm hover:text-blue-600 transition-colors">Privacy Policy</Link>
            </div>
          </div>
        </div>
      </footer>
